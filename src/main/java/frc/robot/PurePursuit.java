...
/**
 * 
 * @brief The PurePursuit class provides path following using the Pure Pursuit 
 * 			algorithm described here: https://www.ri.cmu.edu/pub_files/pub3/coulter_r_craig_1992_1/coulter_r_craig_1992_1.pdf
...
public class PurePursuit {
	...
	private double k_lookAheadTime = 1;		// Time along the path of the next target point	
	...
	public void enableLogging(String logPath)
	{
		synchronized (m_lockWriter)
		{
			...
			m_writer = new CSVWriter("Follow Profile", k_fields);
		}
	}
